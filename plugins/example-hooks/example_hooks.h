...
/**
 * @file example_hooks.h
 * @brief Shared observation state for the example-hooks plugin (M17).
 *
...
/// @brief Counters/last-values recording which engine hooks fired for this plugin.
struct Observed {
    int   thermalEvents   = 0;
...
/// @brief Process-global singleton the plugin's hooks record into.
