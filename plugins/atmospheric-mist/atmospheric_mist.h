...
/**
 * @file atmospheric_mist.h
 * @brief Shared API for the atmospheric-mist reference plugin (M17, distance obscurance).
 *
...
/// @brief Base look of the haze plus the breathing animation. Defaults frame a dusty,
...
/**
 * @brief Singleton accessor, filled by the plugin at init and read by the host — the
