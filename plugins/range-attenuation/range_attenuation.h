...
/**
 * @file range_attenuation.h
 * @brief Shared API for the range-attenuation reference plugin (M17, distance obscurance).
 *
...
/// @brief The lit-range look plus its flicker. Defaults model a modest torch: visible to
...
/// @brief Singleton accessor, filled by the plugin at init and read by the host.
inline API& api() {
    static API instance;
    return instance;
}
