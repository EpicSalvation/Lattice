...
/**
 * @brief Create the engine's concrete renderer, the public seam between an out-of-tree game and the graphics backend (docs/ARCHITECTURE.md §12).
 *
 ...
 *
 * @return an uninitialized renderer; call `initialize()` with the host's
