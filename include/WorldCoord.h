...
/**
 * @brief World-space position type. Wraps glm::dvec3 (64-bit double precision).
 *
...
struct WorldCoord {
    ...
    /**
     * @brief Convert to camera-local single-precision float for GPU submission only.
     *
     * Subtracts cameraOrigin before narrowing, keeping the result small enough
     * to be precise in float32. Never call this for world-space arithmetic.
     */
